...
<div markdown="1" style="border-left: 3px solid #e0e0e0; padding: 0.4em 0.4em; color: #555; font-size: 0.95em; margin: 1.5em 0;">
...
The three Swift options enable C++ interoperability and give Clang the C++
language mode and module map it needs to parse the header.
...
## What Direct Interoperability Does—and Does Not—Provide
