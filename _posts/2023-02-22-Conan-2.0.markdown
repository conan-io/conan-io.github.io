...
- New [public Python API](https://docs.conan.io/2.0/reference/extensions/python_api.html) (currently in preview)
...
- New extensibility capabilities
  - New ability to [customize available settings](https://docs.conan.io/2.0/examples/config_files/settings/settings_user.html) in settings_user.json without modifying the global settings.yml
