...
Conan will generate the binaries for this new architecture and you can safely upload them to your own
 Artifactory, Conan will compute a different packageID because of the new settings value.

Of course, your building machine need to provide the tooling required for this build, but any
 updated Macos should do work.
...
Take into account that ConanCenter uses at the time of writing Conan v1.38,
 new build-helpers were not mature enough to be used in recipes. Some of the
